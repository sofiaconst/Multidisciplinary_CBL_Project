# CLAUDE.md — Hydr8 project instructions

Persistent context for any Claude (terminal / Claude Code / Anthropic Console) working in this repo. Read me first.

## What this project is

A static multi-page website for **Hydr8**, a smart hydration coaster. No build step, no framework install — plain HTML + React (loaded from CDN via Babel Standalone). Runs on any static host or `python3 -m http.server`.
